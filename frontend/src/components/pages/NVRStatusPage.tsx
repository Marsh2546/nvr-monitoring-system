...
import CriticalIssuesAnalysis from "./CriticalIssuesAnalysis";
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <StatusIcon
                      status={getComponentStatus(nvr, "onu") === "normal"}
                    />
                  </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <StatusIcon
                      status={getComponentStatus(nvr, "nvr") === "normal"}
                    />
                  </div>
                  <div className="flex items-center justify-between mt-1">
                    <span className="text-[10px] text-slate-500 font-mono">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          "size-2 rounded-full",
                          getComponentStatus(nvr, "hdd") === "normal"
                            ? "bg-green-500"
                            : getComponentStatus(nvr, "hdd") === "failed"
                              ? "bg-red-500"
                              : "bg-orange-500",
                        )}
                      ></div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          "size-2 rounded-full",
                          getComponentStatus(nvr, "view") === "normal"
                            ? "bg-green-500"
                            : getComponentStatus(nvr, "view") === "failed"
                              ? "bg-red-500"
                              : "bg-orange-500",
                        )}
                      ></div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          "size-2 rounded-full",
                          getComponentStatus(nvr, "login") === "normal"
                            ? "bg-green-500"
                            : getComponentStatus(nvr, "login") === "failed"
                              ? "bg-red-500"
                              : "bg-orange-500",
                        )}
                      ></div>
          ...
          <div className="bg-[#0f172a] p-5 rounded-2xl border border-slate-800/50 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">
                ...
                {summaryStats.total > 0
                  ? (
                      (summaryStats.critical / summaryStats.total) *
                      100
                    ).toFixed(1)
                  : 0}
                % of System Offline
